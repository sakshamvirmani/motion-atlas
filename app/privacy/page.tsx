  ...
  return (
    <main className="account-shell document-shell" id="main-content" tabIndex={-1}>
      ...
      <article>
        ...
        <p>Motion Atlas stores your current lesson, completed lessons, quiz selections, bookmarks, mastery stages, server-calculated review dates, bounded lab controls, a progress revision, and update times. It does not store a password, public profile, free-form private notes, or payment details.</p>
        <h2>Your controls</h2>
